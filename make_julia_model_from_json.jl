...
function main()
  ...
  main_model_dictionary::Dict{String,Any} = parse_json_metabolic_statements(path_to_model_file)
  ...
  problem_object = generate_problem_object(main_model_dictionary,config_dict)
